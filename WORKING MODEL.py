...
for player_list in lists:
    ...
    with open('most_likely_players.txt', 'a') as f:
        f.write('Most Likely Players to Score\n')
        f.write('Player\tPredicted Odds\n')
        f.write('--------------------------------\n')
        for info in player_info[:10]:
            f.write(f'{info["name"]}\t{info["odds"]:.2%}\n\n\n')
